...
import { $SourceErrorCodeList, $TranslatedErrorCodeListMap } from "./index.ts";
...
@Injectable()
export class I18N<
  T extends $SourceErrorCodeList = $SourceErrorCodeList,
  U extends $TranslatedErrorCodeListMap = $TranslatedErrorCodeListMap
> {
