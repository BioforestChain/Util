import { ModuleStroge, Resolve, Injectable } from "../dep_inject/index.ts";
import { $FirstArgument } from "../typings/$types.ts";
@Injectable()
...
export class FlagsHelper {
  constructor(
    ...
    private flagParamStack: FlagParamStack
  ) {}
  ...
  private _applyedFlagMap = new Map<
    string,
   ...
   */
  applyFlags(
    flags: string | Map<string, boolean | number | string | undefined>
  ) {
  ...
  registerInjectionFlag(
    flag: string,
    ModuleFactory: $FirstArgument<typeof Resolve>,
