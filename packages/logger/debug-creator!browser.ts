...
import { $Constructor, $NodeJS } from "../typings/$types.ts";
import { $Browser, $LogArgs, $Scope } from "./$types.ts";
...
class BrowserDebugCreater extends DebugCreater<string> {
  ...
  }`)() as $Constructor<$Browser.HtmlNamespace>;
  ...
  )() as $Constructor<$Browser.HtmlDuration>;
