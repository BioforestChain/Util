...
import { Debug, DebugCreater, LOGGER_LEVEL } from "./common";
/**
 * This is the Node.js implementation of `debug()`.
 */
export class NodejsDebugCreater extends DebugCreater<number> {
  get colorTypeName() {
  ...
  formatArgs(
    ...
    scope: BFChainUtilLogger.Scope<number> = debug,
  ) {
  ...
  private readonly _htmlStylePlaceholder = `HSP${Math.random().toString(36).substr(2)}`;
