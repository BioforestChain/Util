declare namespace BFChainUtil {
  ...
  type InOutSyncEventHandler<IO extends UnknownEventInOut> = SyncEventHandler<IO["in"], IO["out"]>;
  type InOutEventHandler<IO extends UnknownEventInOut> = EventHandler<IO["in"], IO["out"]>;
  type EventInOutMap = {
