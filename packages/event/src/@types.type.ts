declare namespace BFChainUtil {
  ...
  type EventWaitterMap<EM> = {
    [key in keyof EM]?: BFChainUtil.PromiseOut<EM[key]>;
  };
  // type EventWaitterMap<EM> = {
  //   [key in keyof EM]?: import("@bfchain/util-extends-promise-out").PromiseOut<
  //     EM[key]
  //   >;
  // };
  ...
  interface QueneEventEmitterPro<EM extends EventInOutMap = {}>
